...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Hosteller> list=hostellerFacade.findAll();
        //for(Hosteller h: list){
        ...
        String password=request.getParameter("password");
         mySession.setAttribute("id", userid);
         
        System.out.println(password);
        for(Hosteller h:list){
            if(h.getUserid().equals(userid)){
                if(h.getPassword().equals(password)){
                    out.println("Correct username or password<br>");
...
"    display: inline-block;'href='index.html'>Login again or Register</a>");
