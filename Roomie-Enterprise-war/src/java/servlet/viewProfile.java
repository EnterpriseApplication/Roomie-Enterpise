...
public class viewProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //String profID=(String)mySession.getAttribute("viewID");
         String  profID=request.getParameter("key1");
          //out.println(profID);
            
        List <Hosteller> hlist=hostellerFacade.findAll();
        for(Hosteller h: hlist)
        {
            if(h.getUserid().equals(profID))
            {
                out.println("ENROLLMENT: "+h.getUserid()+"\nHOMETOWN: "+h.getHoemtown()+"\nNAME: "+h.getHostellername());
            }
